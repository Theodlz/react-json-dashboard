...
function getCategoryStyle(metrics, statusTypes) {
  ...
  Object.values(metrics).forEach(metric => {
    ...
    if (importance > maxImportance || maxImportance === -1) {
      ...
      maxImportanceBackgroundColor = statusTypes[statusType]?.backgroundColor || "white";
    }
  });
  return {
    marginBottom: 0,
    ...
    border: maxImportanceBackgroundColor ? `2px solid ${maxImportanceBackgroundColor}` : "2px solid grey"
  };
}
function displayValue(metric, statusTypes) {
  ...
  if (Array.isArray(value) && value?.length > 0) {
    if (value.length === 2 && value[0] && value[1] && new Date(`${value[0]} ${value[1]}`).getTime()) {
    ...
    if (Array.isArray(value?.x) && Array.isArray(value?.y) && value.x.length === value.y.length) {
      ...
      val = /*#__PURE__*/React.createElement("svg", {
        viewBox: "0 0 500 200"
      }, value.x_unit && /*#__PURE__*/React.createElement("text", {
        x: "190",
        y: "195",
        fill: "grey",
        fontSize: "1rem"
      }, value.x_unit), value.y_unit && /*#__PURE__*/React.createElement("text", {
        x: "0",
        y: "100",
        fill: "grey",
        fontSize: "1rem"
      }, value.y_unit), /*#__PURE__*/React.createElement("line", {
        x1: "25",
        y1: "25",
        x2: "25",
        y2: "175",
        ...
        fontSize: "1rem",
        textAnchor: "end"
      }, max_y), /*#__PURE__*/React.createElement("text", {
        x: "25",
        y: "175",
        fill: "grey",
        fontSize: "1rem",
        textAnchor: "end"
      }, min_y), /*#__PURE__*/React.createElement("text", {
        x: "25",
        y: "195",
        fill: "grey",
        fontSize: "1rem",
        textAnchor: "middle"
      }, min_x), /*#__PURE__*/React.createElement("text", {
        x: "475",
        y: "195",
        fill: "grey",
        fontSize: "1rem",
        textAnchor: "middle"
      }, max_x), /*#__PURE__*/React.createElement("polyline", {
        fill: "none",
        stroke: "grey",
        strokeWidth: "2",
        points: value.x.map((x, i) => `${(x - min_x) / (max_x - min_x) * 450 + 25},${200 - (value.y[i] - min_y) / (max_y - min_y) * 150 - 25}`).join(" ")
      }), value.x.map((x, i) => /*#__PURE__*/React.createElement("circle", {
      ...
      })), value.x.map((x, i) => /*#__PURE__*/React.createElement("text", {
  ...
  if (typeof val === "string") {
    val = /*#__PURE__*/React.createElement("h5", {
      style: {
        margin: 0,
        padding: 0,
        backgroundColor: statusTypes[type]?.backgroundColor ? statusTypes[type].backgroundColor : null,
        color: statusTypes[type]?.color ? statusTypes[type].color : "black",
        paddingLeft: "0.75rem"
      }
    }, val);
  } else {
...
const JsonDashboard = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, showTitle && /*#__PURE__*/React.createElement("h1", {
    style: {
      margin: 0,
      padding: 0,
      fontSize: "2rem"
    ...
    if (data[category] !== null && typeof data[category] === "object" && Object.keys(data[category]).length > 0) {
      ...
      }, Object.keys(data[category]).map(key => /*#__PURE__*/React.createElement("div", {
        key: key,
        style: {
          margin: 0,
          padding: 0,
      ...
      }, key), displayValue(data[category][key], statusTypes)))));
    }
    return null;
  })));
};
